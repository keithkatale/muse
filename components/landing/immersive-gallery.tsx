...
export function ImmersiveGallery() {
  return (
    <section className="relative border-t border-border/50 bg-gradient-to-b from-[hsl(40,25%,98%)] to-background overflow-hidden">
      {/* Header */}
      ...
      {/* Bottom CTA */}
      <div className="relative z-10 mx-auto max-w-6xl px-6 sm:px-8 pb-24 sm:pb-32">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
